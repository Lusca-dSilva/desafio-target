...
minimo = min(faturamentos)
maximo = max(faturamentos)
...
dias_acima_da_media = len([dia for dia in dados if dia["valor"] > media])

# Imprime os resultados
print("Menor valor de faturamento: R$ {:.2f}".format(minimo))
print("Maior valor de faturamento: R$ {:.2f}".format(maximo))
